...
```
dependencies {
  testCompile('com.epages:restdocs-wiremock:0.6.1')
}
```
...
```
  testCompile('com.epages:wiremock-spring-boot-starter:0.6.1')
```
...
```
testRuntime (group:'com.epages', name:'restdocs-server', version:'0.6.1', classifier:'wiremock', ext:'jar')
``` 
