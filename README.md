...
```
dependencies {
  testCompile('com.epages:restdocs-wiremock:0.6.2')
}
```
...
```
  testCompile('com.epages:wiremock-spring-boot-starter:0.6.2')
```
...
```
testRuntime (group:'com.epages', name:'restdocs-server', version:'0.6.2', classifier:'wiremock', ext:'jar')
``` 
