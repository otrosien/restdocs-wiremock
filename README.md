...
```
dependencies {
  testCompile('com.epages:restdocs-wiremock:0.6.6')
}
```
...
```
testRuntime (group:'com.epages', name:'restdocs-server', version:'0.6.6', classifier:'wiremock', ext:'jar')
``` 
...
```
  testCompile('com.epages:wiremock-spring-boot-starter:0.6.6')
```
