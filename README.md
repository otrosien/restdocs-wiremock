...
dependencies {
  testCompile('com.epages:restdocs-wiremock:0.7.0')
}
```
...
```groovy
testRuntime (group:'com.epages', name:'restdocs-server', version:'0.7.0', classifier:'wiremock', ext:'jar')
``` 
...
```groovy
  testCompile('com.epages:wiremock-spring-boot-starter:0.7.0')
```
